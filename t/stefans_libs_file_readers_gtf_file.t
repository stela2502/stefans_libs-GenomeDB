...
'gene_id "ENSG00000223972.5"; transcript_id "ENST00000456328.2"; gene_type "transcribed_unprocessed_pseudogene"; gene_status "KNOWN"; gene_name "DDX11L1"; transcript_type "processed_transcript"; transcript_status "KNOWN"; transcript_name "DDX11L1-002"; exon_number 3; exon_id "ENSE00002312635.1"; level 2; tag "basic"; transcript_support_level "1"; havana_gene "OTTHUMG00000000961.2"; havana_transcript "OTTHUMT00000362751.1"',
	...
	'gene_id'     => 'ENSG00000223972.5',
	'gene_name'   => 'KNOWN',
	'gene_status' => 'transcribed_unprocessed_pseudogene',
	'gene_type'   => 'ENST00000456328.2',
	'havana_gene' => 'processed_transcript',
	'level'       => 'DDX11L1',
	'score'       => '.',
	'seqname'     => 'chr1',
	'source'      => 'HAVANA',
...
$exp = [ 'seqname', 'source', 'feature', 'start', 'end', 'score', 'strand', 'frame', 'attribute', 'gene_id', 'gene_type', 'gene_status', 'gene_name', 'level', 'havana_gene' ];
...
ok( $test_object->{'__max_header__'} == 15, "internal Max_Header \$test_object ($test_object->{'__max_header__'})" );
...
#$value->{'__max_header__'} = 15;
ok( $value->{'__max_header__'} == 15, "internal Max_Header subset ($value->{'__max_header__'})" );
