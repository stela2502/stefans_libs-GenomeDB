...
is_deeply(
	...
	'simple test of function stefans_libs_file_readers_bed_file -> new()'
);
...
my $other_bed_file = stefans_libs_file_readers_bed_file->new();
$other_bed_file->{'data'} = [
	[ 1, 200, 300,  'geneA' ],
	[ 1, 500, 700,  'geneB' ],
	[ 1, 900, 2000, 'geneC' ],
...
$other_bed_file = stefans_libs_file_readers_bed_file->new();
$other_bed_file->{'data'} = [
	[ 1, 200, 300,  'Ctcf1' ],
	[ 1, 500, 700,  'Ctcf2' ],
	[ 1, 900, 2000, 'Ctcf3' ],
...
#print "\$exp = ".root->print_perl_var_def([split(/[\t]/, $bed_file->efficient_match($bed_file_2, 'test' )->AsString() )] ) .";\n";

$exp = [ 'track type=narrowPeak visibility=3 db=hg19 name="595_3" description="0h (1) vs C1"
chr1', '1', '100', '', '1
chr1', '150', '250', 'geneA Ctcf1 ', '1
chr1', '400', '450', '', '1
chr1', '500', '550', 'geneB Ctcf2 ', '1
chr1', '600', '650', 'geneB Ctcf2 ', '1
chr2', '1', '2000', 'geneD geneE Ctcf4 Ctcf5 ', '1
' ];

is_deeply([split(/[\t]/, $bed_file->efficient_match($bed_file_2, 'test' )->AsString() )], $exp, 'efficient_match' );

$bed_file->print_as_table( "$plugin_path/data/test_bed.narrowPeak" );

ok ( -f "$plugin_path/data/test_bed.narrowPeak" , "Test bed file  '$plugin_path/data/test_bed.narrowPeak'" );
...
chr1', '15980', '16126', 'e_coli_test_1_peak_1', '18', '.', '1.96097', '3.70904', '1.82123', '73
