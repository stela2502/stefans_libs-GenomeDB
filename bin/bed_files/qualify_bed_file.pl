...
this tool uses a table containing the columns info and filename to identify bed files contining some information. If the information in the table is defined this information will be added to all matching bed entries in the target bed file. You can add a relaxing value to the search to widen up the regions in the traget file to match more information regions.
