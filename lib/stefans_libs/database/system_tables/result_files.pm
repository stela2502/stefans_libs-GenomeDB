...
sub new {
    ...
    bless $self, $class if ( $class eq "result_files" );
...
sub  init_tableStructure {
     ...
     $self->{'Group_to_MD5_hash'} = ['tagkey', 'description', 'file_location' ]; # define which values should be grouped to get the 'md5_sum' entry
