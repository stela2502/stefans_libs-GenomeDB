...
sub new {
	...
	$self = {
		...
		'stefans_libs::file_readers::bed_file'      => 20,
		'genome_height'                           => 150,
	};
...
The data has to be of type 'stefans_libs::file_readers::bed_file' or 'stefans_libs::file_readers::bedGraph_file'
to be plotted.
...
sub AddDataset {
	...
	unless ( ref($data) eq 'stefans_libs::file_readers::bedGraph_file' ) {
		unless ( ref($data) eq 'stefans_libs::file_readers::bed_file' ) {
			Carp::confess(
"Sorry, but you can only add 'stefans_libs::file_readers::bedGraph_file'"
				  . "or 'stefans_libs::file_readers::bed_file' objects to the graph!\n"
				  . "Not '"
				  . ref($data)
				  . "'\n" );
		}
...
'stefans_libs::file_readers::bed_file' or
'genome'.
